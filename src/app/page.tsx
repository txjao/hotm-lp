    ...
    <main className="">
        ...
        <section id="banner" className={`flex justify-center items-center bg-[url('../assets/bannerHero.png')] bg-no-repeat bg-cover bg-center h-[99.8vh]`}>
          <div className="flex items-center flex-col gap-16">
            <div className="flex items-center flex-col">
              ...
              2xl:w-[80%]  xl:w-[80%] xl:text-lg lg:text-lg lg:w-[80%] md:text-base md:w-full">JÁ IMAGINOU APRENDER A CONQUISTAR LINDAS MULHERES UTILIZANDO SUA REDE SOCIAL?</h1>
      ...
      <section id="third-section" className="flex bg-white h-[80vh] justify-between items-center p-16 gap-20 lg:p-8">
        ...
        <div className="flex items-center flex-col w-3/4 gap-20 lg:gap-8 md:gap-4">
          <p className="text-black text-base text-left xl:text-sm lg:text-sm md:text-xs">
      ...
      <section id="fourth-section" className="flex h-[50vh] bg-gradient-to-r from-black via-black to-red justify-between">
        ...
        <div className="flex justify-center items-center flex-col gap-20 text-center xl:gap-10 lg:gap-4">
          <p className="text-base w-[80%] xl:w-[60%] lg:text-sm md:h-12 md:text-xs">Aprenda a conquistar mulheres nas redes sociais de forma cuidadosa, respeitosa e eficaz. Desenvolva métodos de abordagem que garantem sucesso!<br /><strong className="text-red-secondary font-semibold">Comece já!</strong></p>
