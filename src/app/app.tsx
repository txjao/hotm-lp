    ...
    return (
        <>
            ...
            2xl:text-base xl:text-base lg:text-baseSm md:text-sm"> Adquira já </a>
                        ...
                        <div id="banner" className={`flex justify-center items-center bg-[url('../assets/bannerHero.png')] bg-no-repeat bg-cover bg-center h-[99.8vh]`}>
            ...
            {windowWidth <= breakpoint &&
                <main className="">
                    <section className="first-section">
                        <header className="fixed flex h-[10vh] items-center p-10 bg-black">
                            <div className="flex gap-10">
                                <a href="#third-section" className="text-yellow text-sm underline"> Saiba Mais </a>
                                <a href="#second-section" className="text-yellow text-sm underline"> Quem sou </a>
                                <a href="https://pay.hotmart.com/E92520462X" className="text-yellow text-sm underline"> Adquira já </a>
                            </div>
                        </header>
                        <div id="banner" className={`flex justify-center items-center bg-[url('../assets/bannerHero.png')] bg-no-repeat bg-cover bg-center h-[99.8vh]`}>
                            <div className="flex items-center flex-col gap-16">
