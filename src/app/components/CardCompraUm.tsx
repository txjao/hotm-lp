...
export default function CardCompraUm() {
    return (
        ...
        <div className="px-1 pb-8 pt-6 text-center">
          <a href="https://pay.hotmart.com/E92520462X" className="py-4 px-6 lg:py-6 lg:px-12 bg-yellow hover:bg-yellow-hover duration-200 rounded-full w-full">Aqduira já!</a>
        </div>
      </div>
    )
}